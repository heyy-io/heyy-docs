...
<Frame>
  ![Exit Points tab listing the exit points configured for an AI Employee](/assets/ai-employees-exit-points-hero.png)
</Frame>
...
<Frame>
  ![Table of example exit point names and their trigger conditions](/assets/ai-employees-exit-points-examples.png)
</Frame>
