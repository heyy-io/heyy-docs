...
5. **Test before saving**, using both modes available:
   ...
   Check both a **success response** and a **failure response** in your live test — if the external service goes down and the employee has no sensible way to talk about that, the contact gets a broken or confusing reply instead of a graceful handoff.
