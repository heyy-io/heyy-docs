...
<Frame>
  ![Four guideline category accordions on the Identity & guidelines tab](/assets/ai-employees-guidelines-categories.png)
</Frame>
...
<Frame>
  ![New guideline form with title, prompt field, and Optimize and Save buttons](/assets/ai-employees-guidelines-add.png)
</Frame>
...
<Frame>
  ![@ mentions dropdown open in a guideline's prompt editor, showing Attributes, Actions, and Content options](/assets/ai-employees-guidelines-mentions.png)
</Frame>
