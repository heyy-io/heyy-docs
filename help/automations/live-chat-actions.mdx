...
- **Ask and branch on the reply:** Use “Wait for reply” and “Save text reply to”, then add a [Condition](/help/automations/logic-actions#condition) or [AI Intention Recognition](/help/automations/ai-actions#ai-intention-recognition) to branch the automation (e.g. route to sales vs. support) based on what the contact replied.
- **Confirm or follow up after another action:** After an [Assign Chat](/help/automations/chats-actions#assign-chat), [Set Attribute](/help/automations/contacts-actions#set-attribute), or other step, use Send Message to tell the contact what happens next (e.g. “We’ve assigned your chat to Sarah” or “Please share your order number”).
