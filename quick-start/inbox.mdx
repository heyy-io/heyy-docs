...
<Note>
For even more control, you can use logic-based filters (e.g., `contacts with label = VIP AND last name = Smith`) to refine results.
</Note>
...
<Note>
Notes do **not** send anything to the contact.
</Note>
