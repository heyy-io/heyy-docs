...
<Info>
  Navigate to [**Settings \> WhatsApp Templates**](https://app.heyy.io/settings/whatsapp-templates) to manage your templates.
</Info>
...
<AccordionGroup>
  <Accordion title="Text Header">
    Text headers allow for a short title at the top of your message.

    <Info>
      Supports a maximum of **one** variable. Markdown characters (like bold or italics) are not supported.
    </Info>
  </Accordion>
  <Accordion title="Media Header (Image, Video, Document)">
...
The body is the primary content and the only required component. You can enhance your message using [WhatsApp formatting](https://faq.whatsapp.com/539178204879377) and dynamic data:
...
<Info>
  **Note on Button Display:** If you add more than 3 buttons, WhatsApp displays the first 2 and collapses the rest into a **"See all options"** menu.
</Info>
...
<AccordionGroup>
  <Accordion title="Quick Reply">
    ...
    <Info>
      Highly effective for [Automations](https://docs.heyy.io/quick-start/automations/getting-started) to trigger specific flows.
    </Info>
  </Accordion>
  <Accordion title="Visit Website">
    A CTA button that opens a specific URL. You can use variables to create personalized links.
...
<Info>
  **Approval Process:** By default, all templates are submitted under the **Utility** category. Review typically takes up to **24 hours**, though newer accounts may experience longer wait times.
</Info>
