...
> _Note_
_When using workflow variables, keep in mind that they are session-based. This means they are reset each time the workflow is triggered or run, preventing data from carrying over between sessions._
