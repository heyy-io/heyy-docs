...
| 429       | Too many requests | Returned when you exceed the [rate limit](/api-reference/v3/rate-limiting). Throttle requests and use the rate limit headers to retry appropriately.       |
