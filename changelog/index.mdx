...
<Update label="May 21, 2026">
  ## Authentication WhatsApp template (Early access)
</Update>
...
<Update label="May 6, 2026">
  ## Message translation in chat (Early access)
</Update>
...
<div className="changelog-month-header">
  ...
  <div className="changelog-month-content">
    <span className="changelog-month-kicker">PRODUCT UPDATES</span>
    <h2 className="mt-1 mb-0 text-[26px] font-extrabold leading-[1.15] scroll-mt-[184px]">July 2026</h2>
  </div>
</div>
...
<Update label="July 14, 2026">
  ...
  **API v3** is a new version of our API that is more consistent, easier to use, and more powerful. It is a major update to our API and is not backwards compatible.
</Update>
...
<Update label="June 13, 2026">
  ...
  <Frame>
    ![AI Employee v2](/assets/13-06-2026-changelog.png)
  </Frame>
...
<Update label="June 12, 2026">
  ...
  <Frame>
    ![URL buttons for WhatsApp, Instagram, and Facebook](/assets/12-06-2026-changelog.png)
  </Frame>
...
<Update label="June 10, 2026">
  ...
  <Frame>
    ![Search by message content](/assets/10-06-2026-changelog.png)
  </Frame>
...
<Update label="May 26, 2026">
  ...
  <Frame>
    ![New Facebook comment trigger](/assets/26-05-2026-changelog.png)
  </Frame>
